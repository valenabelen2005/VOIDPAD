...
const faqData = {
  en: [
    ...
    { q: 'How long does shipping take?', a: 'After production, delivery to most EU addresses takes 5–10 business days. You will receive a tracking link once your order is shipped.' },
    { q: 'Do you ship outside the EU?', a: 'Currently we focus on EU shipping. If you are outside the EU and want to place an order, contact us and we will do our best to find a solution.' },
  ...
  es: [
    ...
    { q: '¿Cuánto tarda el envío?', a: 'Tras la producción, la entrega a la mayoría de direcciones de la UE tarda 5–10 días hábiles. Recibirás un enlace de seguimiento una vez enviado tu pedido.' },
    { q: '¿Enviáis fuera de la UE?', a: 'Actualmente nos centramos en envíos dentro de la UE. Si estás fuera de la UE y quieres realizar un pedido, contáctanos e intentaremos encontrar una solución.' },
